const fs = require('fs')
const filePath = './data/kepler/notts8000/'
const filePaths = ['./data/kepler/notts8000/', './data/kepler/london8000/', './data/kepler/bbn8000/', './data/kepler/bbcentral8000/', './data/kepler/bbse8000/', './data/kepler/bbcap8000/']
const fileNames = ['roads.wkt', 'tracks.wkt']
...
CSVtoWKT('./data/kepler/routes_container/', 'roads.csv')

// filePaths.forEach(filePath => {
//   fileNames.forEach(fileName => {
//     WKTtoCSV(filePath, fileName);
//   })
// })