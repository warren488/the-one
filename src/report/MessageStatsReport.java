...
public class MessageStatsReport extends Report implements MessageListener {
	...
	private double deliveredBufferTime;
	...
	public void done() {
		...
		String statsText = 
			...
			"," + format(calculateAverage(this.latencies) / calculateIntAverage(this.hopCounts)) +
